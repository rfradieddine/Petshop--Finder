...
export default function MelhorPetshopForm() {
  ...
  >
    <TextField id="data" label="Data Banho" variant="outlined" onChange={handleChange} />
    <TextField id="qtdCaesPequenos" label="Quantidade de Cães Pequenos" variant="outlined" onChange={handleChange} />
    <TextField id="qtdCaesGrandes" label="Quantidade Cães Grandes" variant="outlined" onChange={handleChange} />
  </Box>
</Box>
            ...
            <Button type="submit" variant="contained" color="primary" sx={{backgroundColor: '#fc8b22'}}>Encontre o Melhor Petshop</Button>
